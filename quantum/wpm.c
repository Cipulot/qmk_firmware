...
void set_current_wpm(uint8_t new_wpm) { s_wpm_state.wpm_displayed = new_wpm; }

uint8_t get_current_wpm(void) { return s_wpm_state.wpm_displayed; }
...
void decay_wpm(void) { process_wpm(WPM_PROCESS_DECAY); }