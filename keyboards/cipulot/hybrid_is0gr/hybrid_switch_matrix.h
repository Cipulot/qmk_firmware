...
typedef struct {
    ...
    uint8_t  rescaled_mode_1_actuation_offset;        // offset for key press in mode 1 rescaled to actual scale
    uint8_t  rescaled_mode_1_release_offset;          // offset for key release in mode 1 rescaled to actual scale
